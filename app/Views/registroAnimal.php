...
<header>
    ...
    <section class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center column-responsive">
                ...
                <a href="<?= site_url('/animales/listado')?>" class="btnbase btnprimary-outline margin-bottom"><i class="fas fa-list-ul me-2"></i>Ver lista de animales</a>
            </div>
            <div class="card-form">
            <div class="row align-items-center">
                ...
                <button class="btnbase btnprimary w-100 margin-bottom">Registrar animal</button>
                </div>
                </form>
                <div class="col-md-6">
