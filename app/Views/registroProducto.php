    ...
    <section class="mb-4">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center column-responsive">
                ...
                <a href="<?= site_url('/productos/listado')?>" class="btnbase btnprimary-outline margin-bottom"><i class="fas fa-list-ul me-2"></i>Ver inventario</a>
            </div>
            <div class="card-form">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <form action="<?= site_url('/productos/nuevo')?>" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                <label for="" class="form-label">Nombre del producto<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="product" placeholder="Ingrese el nombre del producto">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-4">
                                <label for="" class="form-label">Fotografía<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="photo" placeholder="Pegue la url de la imagen">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="price" placeholder="Ingrese el precio por unidad">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-4">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Añade una descripción del producto<span class="text-danger">*</span></label>
                            <textarea class="form-control" name="description" rows="3"></textarea>
                        </div>
                        <button class="btnbase btnprimary w-100 margin-bottom">Registrar producto</button>
                    </form>
                </div>
                <div class="col-md-6 text-center margin-mobile">
                    <img class="w-100" src="<?= base_url('public/img/productos.png')?>" alt="">
                </div>
        </div>
        </div>
        </div>
